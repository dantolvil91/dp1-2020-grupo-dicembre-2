...
@Controller
public class CinemaRoomController<OfferService> {
	...
	@Autowired
	public CinemaRoomController(OfferService offerService) {
	...
	public String initCreationForm(Map<String, Object> model) {
		CinemaRoom actor = new CinemaRoom(null, null, null, null, null, null);
		model.put("actor", actor);
		return VIEWS_OFFER_CREATE_OR_UPDATE_FORM;
	}

	@PostMapping(value = "/offers/new")
	public String processCreationForm(@Valid CinemaRoom offer, BindingResult result) {
		if (result.hasErrors()) {
			return VIEWS_OFFER_CREATE_OR_UPDATE_FORM;
		}
		else {
	...
	public String initFindForm(Map<String, Object> model) {
		model.put("offer", new CinemaRoom(null, null, null, null, null, null));
		return "offers/findoffers";
	}

	@GetMapping(value = "/offers")
	public String processFindForm(CinemaRoom offer, BindingResult result, Map<String, Object> model) {
		...
		Collection<CinemaRoom> results = this.offerService.findOfferByLastName(offer.getName());
		if (results.isEmpty()) {
			// no actors found
	...
	/*	CinemaRoom offer = this.offerService.findOfferById(offerId);
		model.addAttribute(offer); */
		return VIEWS_OFFER_CREATE_OR_UPDATE_FORM;
	}

	@PostMapping(value = "/actors/{actorId}/edit")
	public String processUpdateOwnerForm(@Valid CinemaRoom offer, BindingResult result,
