...
public class VisitController {
	...
	public Rating loadPetWithVisit(@PathVariable("petId") int petId) {
		Session pet = this.petService.findPetById(petId);
		Rating visit = new Rating();
		pet.addVisit(visit);
		return visit;
	}
	...
	public String processNewVisitForm(@Valid Rating visit, BindingResult result) {
		if (result.hasErrors()) {
			return "pets/createOrUpdateVisitForm";
		}
		else {
