...
import org.springframework.samples.peliculasOnline.service.RatingService;
...
public class RatingController {
	...
	public String initCreationForm(Map<String, Object> model) {
		Rating rating = new Rating(null, null);
		model.put("rating", rating);
		return VIEWS_RATING_CREATE_OR_UPDATE_FORM;
	}

	@PostMapping(value = "/ratings/new")
	public String processCreationForm(@Valid Rating rating, BindingResult result) {
		if (result.hasErrors()) {
			return VIEWS_RATING_CREATE_OR_UPDATE_FORM;
		}
		else {
	...
	public String initFindForm(Map<String, Object> model) {
		model.put("rating", new Rating(null, null));
		return "ratings/findratings";
	}

	@GetMapping(value = "/ratings")
	public String processFindForm(Rating rating, BindingResult result, Map<String, Object> model) {
		...
		Collection<Rating> results = this.ratingService.findRatingByLastName(rating.getName());
		if (results.isEmpty()) {
			// no ratings found
	...
	public String initUpdateOwnerForm(@PathVariable("ratingId") int ratingId, Model model) {
		Rating rating = this.ratingService.findRatingById(ratingId);
		model.addAttribute(rating);
		return VIEWS_RATING_CREATE_OR_UPDATE_FORM;
	}

	@PostMapping(value = "/ratings/{ratingId}/edit")
	public String processUpdateOwnerForm(@Valid Rating rating, BindingResult result,
