 ...
 */
@Component
public class PetTypeFormatter implements Formatter<Seat> {
	...
	@Override
	public String print(Seat petType, Locale locale) {
		return petType.getName();
	}

	@Override
	public Seat parse(String text, Locale locale) throws ParseException {
		Collection<Seat> findPetTypes = this.peService.findPetTypes();
		for (Seat type : findPetTypes) {
